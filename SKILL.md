...
| 05 | `codex-supabase` | 連接 Supabase |
| 06 | `codex-firebase` | 連接 Firebase |
| 07 | `codex-ollama` | 本地 AI Ollama |
| 08 | `codex-gemini` | Gemini 免費 API |
| 09 | `codex-draw` | 生圖指引（內建 + API） |
| 10 | `codex-install-all` | 一次安裝全部 |
